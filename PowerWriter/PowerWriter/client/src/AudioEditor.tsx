...
import { Timeline, TimelineLayer } from "./components/Timeline";
    ...
    try {
      ...
      const playNextItem = () => {
        ...
        if (item.type === 'segment') {
          ...
          // Update word highlighting and timeline during segment playback
          const updateWordHighlight = () => {
            ...
            const totalElapsed = playbackStartTimeRef.current 
              ? audioContext.currentTime - playbackStartTimeRef.current 
              : 0;
            setTimelineCurrentTime(item.playbackStartTime + elapsed);
