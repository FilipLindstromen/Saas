...
| TypoAnimation | `/TypoAnimation` | Kinetic-typography VSL generator: script → styled animated scenes and live preview on GitHub Pages; webcam sync, b-roll, and MP4 export need the full app run locally |
